...
## 5. Administracion de productos en la app

Cuando un usuario inicia sesion, la app revisa si su correo existe en
`admins`. Si existe, la pantalla de tienda muestra:
...
Para que un usuario vea estas opciones, crea el documento admin con el correo
en minusculas:
...
## 9. Reglas temporales para pruebas
...
Ejemplo inicial para produccion:
...
Si tus correos admin estan guardados en minusculas, registra tambien los correos
de Authentication en minusculas para que la regla coincida.
